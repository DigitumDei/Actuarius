...
Optional: `DATABASE_PATH`, `REPOS_ROOT_PATH`, `ASK_CONCURRENCY_PER_GUILD`, `ASK_EXECUTION_TIMEOUT_MS`, `REQUEST_STUCK_TIMEOUT_MS`, `REQUEST_STUCK_SCAN_INTERVAL_MS`, `DISCORD_GUILD_ID` (dev: guild-scoped command registration), `LOG_LEVEL`, `THREAD_AUTO_ARCHIVE_MINUTES`, `GIT_USER_NAME`, `GIT_USER_EMAIL`
