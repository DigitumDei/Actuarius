export function buildHelpText(): string {
  return [
    ...
    "- `/revise [findings:<text>]` Re-run planner-verified implementation on the current plan thread. Findings can be provided explicitly or will be pulled from the latest review summary (request owner or Manage Server).",
